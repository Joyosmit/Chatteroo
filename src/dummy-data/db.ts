export const conversations = [
	{
        // In case group chat, then admin, else admin: null
		_id: "1",
		admin: "user1",
		groupImage: null,
		groupName: "Group A",
		...
		// isGroup: true,
		_creationTime: 1714919851, // Unix timestamp for 2021-11-30 12:04:32 UTC
		lastMessage: {
			_id: "1",
			messageType: "text",
			content: "Hello everyone! How are you doing? 🤗 hello its me star man ye",
			sender: "user1",
		},
		sender: "user1",
		isOnline: true,
